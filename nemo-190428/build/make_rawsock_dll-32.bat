...
@echo on
gcc -Wall -D_JNI_IMPLEMENTATION_ -Wl,--kill-at -o %LIB_PATH%/%LIB_NAME%.dll -shared -I%JAVA_PATH%/include -I%JAVA_PATH%/include/win32 %SRC_FILES% -l wsock32 -l Ws2_32